...
if(isset($_POST['submit'])) {
  ...
  if (mysqli_query($conn, $sql)) {
    ...
    $from = "farmers.app.test@gmail.com";
$subject = "Test Email";
$message = "Your account is created! you can login with your credentiels. username: your email, password: $password";
$headers = "farmers account";

$result = send_mail($name, $message, 'Your account is created!');
print_r($result);die;
if (true !== $result)
{
                    ...
                    <div class="app-main__inner">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header">Create New Admin
                                </div>
                                    <div class="d-block text-center card-footer">
                                        ...
                                        <form  method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <div class="form-row">
                                                ...
                                                <input type="text" name="name" class="form-control" required id="inputEmail4" placeholder="Name">
                                                </div>
                                                <div class="form-group col-md-6">
