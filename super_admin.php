                    ...
                    <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Total Clients in our Farmer</div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Active Admins</div>
                                            <div class="widget-subheading">Total Active Admins</div>
                                        </div>
                                        <div class="widget-content-right">
                                ...
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Total Admins in our Farmer</div>
                                        </div>
                                        <div class="widget-content-right">
                                ...
                                <div class="card-header">Active Users
                                        <div class="btn-actions-pane-right">
                                            <div role="group" class="btn-group-sm btn-group">
                                                <a href="add_admin.php" class="active btn btn-focus">Add new admin</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                                ...
                                                <td class="text-center">
                                                <p style="display:inline-block"> <a  class="btn btn-primary btn-sm" href='edit.php?id="<?php echo $row['id']; ?>"'>Edit</a>
                                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                    <input type="submit" class="btn btn-danger btn-sm" name="delete" value="Delete" onclick="return confirm('Are you sure you want to delete this admin?')">
                                                    </form> </p>
